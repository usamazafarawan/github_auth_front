...
import { DrawCommandHandler } from '../bpmn/DrawCommandHandler';
import '../../extensionsJSM/Figures.js';
import { BPMNLinkingTool, BPMNRelinkingTool, PoolLink } from '../bpmn/BPMNClasses';
  ...
  const subProcessGroupTemplate = $(go.Group, 'Spot',
    {
      ...
      memberValidation: function (thisGroup: go.Group | null, part: go.Part) {
        return (
